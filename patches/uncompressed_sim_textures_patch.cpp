...
REGISTER_PATCH(UncompressedSimTexturesPatch, {
    ...
    .description = "Forces textures for sims to be uncompressed during gameplay, like they are in CAS.\n"
                   ...
                   "Currently experimental as it is unknown how these changes interact with the game's caches.",
    .category = "Graphics",
    .experimental = true,
    ...
    .technicalDetails = {
        ...
        "The reason why DXVK is borderline-required to use this patch is because native D3D9 stores textures in both the VRAM and the system RAM,\n"
        "which means the larger uncompressed textures may quickly fill the system RAM.\n"
        "This is not an issue with DXVK as it stores only a small portion of textures in the system RAM.",
